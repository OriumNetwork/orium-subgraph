...
describe("Lending events", () => {
  ...
  test("Testing handleGotchiLendingClaimed", () => {
    ...
    assert.fieldEquals(
      "ClaimedToken",
      "0x7777777777777777777777777777777777777777" + "-100",
      "rental",
      "100"
    );
    assert.fieldEquals(
    ...
    assert.fieldEquals(
      "ClaimedToken",
      "0x8888888888888888888888888888888888888888" + "-100",
      "rental",
      "100"
    );
    assert.fieldEquals(
    ...
    assert.fieldEquals(
      "ClaimedToken",
      "0x9999999999999999999999999999999999999999" + "-100",
      "rental",
      "100"
    );
    assert.fieldEquals(
