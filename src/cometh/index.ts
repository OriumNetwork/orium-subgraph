...
export { handleRentalOfferCreated } from "./rental-protocol/rental-offer-created-handler";
...
export { handleRequestToEndRentalPrematurely } from "./rental-protocol/request-end-rental-handler";